    ...
    let result: Result<Value, Box<dyn std::error::Error>> = (|| {
        Ok(match op {
            ...
            "capabilities" => json!({
                ...
                "operations":["capabilities","identity","inventory","observations","activation_require","activation_acquire","activation_renew","activation_release","activation_status","activation_fence","create","delete","clone","start","stop"],
