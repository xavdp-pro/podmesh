...
inspection() {
  ...
  jq -e 'type == "object" and .schema_version == 3' "$work/inspection-raw.json" >/dev/null || {
    echo 'Unsupported candidate inspection schema; expected private input version 3' >&2
    return 1
  }
