...
export default function Fractals({containers,relationships,relationshipStatus='unavailable',relationshipError,onSelect}){
 ...
 const related=base.fractals.flatMap(fractal=>fractal.nodes),filterSources=[...universes,...related],invalidObserved=base.invalidObserved.slice(0,MAX_RENDERED_INVALID_RECORDS);
