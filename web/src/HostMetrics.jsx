...
export default function HostMetrics({host}){
 ...
 const supported=host.responses.capabilities?.data?.operations?.includes('host_resource_metrics');
 ...
 const status=!supported?'Unsupported by installed runtime':failed?'Metrics unavailable':metrics?'Metrics observed':'Waiting for metrics';
